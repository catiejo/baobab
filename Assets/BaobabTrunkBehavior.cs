...
public class BaobabTrunkBehavior : MonoBehaviour 
{
	...
	IEnumerator ScaleOverTime(float time)
	{
		...
		Vector3 destinationScale = new Vector3(0.15f, 0.25f, 0.15f);
		Vector3 finalScale = new Vector3(0.25f, 0.25f, 0.25f);
		...
		do
		{
			gameObject.transform.localScale = Vector3.Lerp(destinationScale, finalScale, currentTime / time);
			currentTime += Time.deltaTime;
			yield return null;
